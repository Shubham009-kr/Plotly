...
export default function Home() {
  ...
  const handleUploadComplete = async (base64Image: string) => {
    const newId = Date.now().toString(); // Generate a unique ID for the new project (you can replace this with your own ID generation logic)
    ...
    <div className="home">
      ...
      <section className="hero">
        ...
        <p className="subtitle">
          Plotly is an AI-first design environment that helps you visualize, render, and ship 
            ...
            <div className="project-card group">
              ...
              <div className="card-body">
                <div>
                  ...
                  <div className="meta">
                    <Clock size={12} />
                    <span>{new Date('01.23.2026').toLocaleDateString()}</span>
                    <span>By SLYTHRN</span>
                  </div>
                </div>
                <div className="arrow">
